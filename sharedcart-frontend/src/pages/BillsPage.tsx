...
const BillsPage: React.FC = () => {
  ...
  const handleCreateBill = (billData: any) => {
    console.log('BillsPage: handleCreateBill called', billData);
    dispatch(createBill(billData))
      .unwrap()
      .then(() => {
        console.log('BillsPage: Bill created successfully');
      ...
      .catch((error) => {
        console.error('BillsPage: Failed to create bill:', error);
      });
  };
